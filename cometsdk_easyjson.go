...
func easyjsonB7f3de24Decode(in *jlexer.Lexer, out *WindowsCodeSignProperties) {
	...
	for !in.IsDelim('}') {
		...
		case "WindowsCodeSignRelicServerURL":
			out.WindowsCodeSignRelicServerURL = string(in.String())
		case "WindowsCodeSignRelicKeypairFile":
			out.WindowsCodeSignRelicKeypairFile = string(in.String())
		case "WindowsCodeSignRelicKeyName":
			out.WindowsCodeSignRelicKeyName = string(in.String())
		default:
...
func easyjsonB7f3de24Encode(out *jwriter.Writer, in WindowsCodeSignProperties) {
	...
	{
		const prefix string = ",\"WindowsCodeSignRelicServerURL\":"
		out.RawString(prefix)
		out.String(string(in.WindowsCodeSignRelicServerURL))
	}
	{
		const prefix string = ",\"WindowsCodeSignRelicKeypairFile\":"
		out.RawString(prefix)
		out.String(string(in.WindowsCodeSignRelicKeypairFile))
	}
	{
		const prefix string = ",\"WindowsCodeSignRelicKeyName\":"
		out.RawString(prefix)
		out.String(string(in.WindowsCodeSignRelicKeyName))
	}
	...
	for !in.IsDelim('}') {
		...
		case "Components":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v43 VSSComponent
					(v43).UnmarshalEasyJSON(in)
					out.Components = append(out.Components, v43)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode21(out *jwriter.Writer, in VSSWriterInfo) {
	...
	}
	{
		...
		if in.Components == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v44, v45 := range in.Components {
				if v44 > 0 {
					out.RawByte(',')
				}
		...
		case "Disks":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Disks = append(out.Disks, v49)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Decode36(in *jlexer.Lexer, out *UserProfileConfig) {
	...
	for !in.IsDelim('}') {
		...
		case "Emails":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Emails = append(out.Emails, v52)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "OverrideEmailSettings":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v53 UserCustomEmailSettings
					(v53).UnmarshalEasyJSON(in)
					(out.OverrideEmailSettings)[key] = v53
					in.WantComma()
				}
				in.Delim('}')
			}
		...
		case "Destinations":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v54 DestinationConfig
					(v54).UnmarshalEasyJSON(in)
					(out.Destinations)[key] = v54
					in.WantComma()
				}
				in.Delim('}')
			}
		...
		case "BackupRules":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v56 BackupRuleConfig
					(v56).UnmarshalEasyJSON(in)
					(out.BackupRules)[key] = v56
					in.WantComma()
				}
				in.Delim('}')
			}
		...
		case "LinuxHomedirSandbox":
			out.LinuxHomedirSandbox = bool(in.Bool())
		default:
			out.UnmarshalUnknown(in, key)
		}
		in.WantComma()
...
func easyjsonB7f3de24Encode36(out *jwriter.Writer, in UserProfileConfig) {
	...
	}
	{
		...
		if in.OverrideEmailSettings == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v60First := true
			for v60Name, v60Value := range in.OverrideEmailSettings {
				if v60First {
					v60First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Destinations == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v61First := true
			for v61Name, v61Value := range in.Destinations {
				if v61First {
					v61First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Sources == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v62First := true
			for v62Name, v62Value := range in.Sources {
				if v62First {
					v62First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.BackupRules == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v63First := true
			for v63Name, v63Value := range in.BackupRules {
				if v63First {
					v63First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Devices == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v64First := true
			for v64Name, v64Value := range in.Devices {
				if v64First {
					v64First = false
				} else {
					out.RawByte(',')
	...
	{
		const prefix string = ",\"LinuxHomedirSandbox\":"
		out.RawString(prefix)
		out.Bool(bool(in.LinuxHomedirSandbox))
	}
	in.MarshalUnknowns(out, false)
	out.RawByte('}')
}
	...
	for !in.IsDelim('}') {
		...
		case "FileAndFolderMandatoryExclusions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v65 ExtraFileExclusion
					(v65).UnmarshalEasyJSON(in)
					out.FileAndFolderMandatoryExclusions = append(out.FileAndFolderMandatoryExclusions, v65)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "DefaultSources":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v66 SourceConfig
					(v66).UnmarshalEasyJSON(in)
					(out.DefaultSources)[key] = v66
					in.WantComma()
				}
				in.Delim('}')
			}
		case "DefaultSourcesBackupRules":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v67 BackupRuleConfig
					(v67).UnmarshalEasyJSON(in)
					(out.DefaultSourcesBackupRules)[key] = v67
					in.WantComma()
				}
				in.Delim('}')
			}
		case "DefaultSourcesWithOSRestriction":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v68 DefaultSourceWithOSRestriction
					(v68).UnmarshalEasyJSON(in)
					(out.DefaultSourcesWithOSRestriction)[key] = v68
					in.WantComma()
				}
				in.Delim('}')
			}
		case "DefaultBackupRules":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v69 BackupRuleConfig
					(v69).UnmarshalEasyJSON(in)
					(out.DefaultBackupRules)[key] = v69
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode37(out *jwriter.Writer, in UserPolicy) {
	...
	if len(in.FileAndFolderMandatoryExclusions) != 0 {
		...
		{
			out.RawByte('[')
			for v70, v71 := range in.FileAndFolderMandatoryExclusions {
				if v70 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.DefaultSources == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v72First := true
			for v72Name, v72Value := range in.DefaultSources {
				if v72First {
					v72First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.DefaultSourcesBackupRules == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v73First := true
			for v73Name, v73Value := range in.DefaultSourcesBackupRules {
				if v73First {
					v73First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.DefaultSourcesWithOSRestriction == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v74First := true
			for v74Name, v74Value := range in.DefaultSourcesWithOSRestriction {
				if v74First {
					v74First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.DefaultBackupRules == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v75First := true
			for v75Name, v75Value := range in.DefaultBackupRules {
				if v75First {
					v75First = false
				} else {
					out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "Reports":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v76 EmailReportConfig
					(v76).UnmarshalEasyJSON(in)
					out.Reports = append(out.Reports, v76)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "Devices":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v79 UpdateCampaignStatusDeviceEntry
					(v79).UnmarshalEasyJSON(in)
					out.Devices = append(out.Devices, v79)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode48(out *jwriter.Writer, in U2FSignRequest) {
	...
	}
	{
		...
		if in.RegisteredKeys == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v83, v84 := range in.RegisteredKeys {
				if v83 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "RegisteredKeys":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v85 U2FRegisteredKey
					(v85).UnmarshalEasyJSON(in)
					out.RegisteredKeys = append(out.RegisteredKeys, v85)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "RegisterRequests":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v86 U2FRegisterRequest
					(v86).UnmarshalEasyJSON(in)
					out.RegisterRequests = append(out.RegisterRequests, v86)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode49(out *jwriter.Writer, in U2FRegistrationChallengeResponse) {
	...
	}
	{
		...
		if in.RegisteredKeys == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v87, v88 := range in.RegisteredKeys {
				if v87 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.RegisterRequests == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v89, v90 := range in.RegisterRequests {
				if v89 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "AllowedProvidersWhenRestricted":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v91 uint64
					v91 = uint64(in.Uint64())
					out.AllowedProvidersWhenRestricted = append(out.AllowedProvidersWhenRestricted, v91)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode60(out *jwriter.Writer, in StorageVaultProviderPolicy) {
	...
	}
	{
		...
		if in.AllowedProvidersWhenRestricted == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v92, v93 := range in.AllowedProvidersWhenRestricted {
				if v92 > 0 {
					out.RawByte(',')
				}
				out.Uint64(uint64(v93))
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "LocalStorage":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v94 LocalStorageDirectory
					(v94).UnmarshalEasyJSON(in)
					out.LocalStorage_Legacy = append(out.LocalStorage_Legacy, v94)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ReplicateTo":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v95 ReplicaServer
					(v95).UnmarshalEasyJSON(in)
					out.ReplicateTo = append(out.ReplicateTo, v95)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode61(out *jwriter.Writer, in StorageRoleOptions) {
	...
	if len(in.LocalStorage_Legacy) != 0 {
		...
		{
			out.RawByte('[')
			for v96, v97 := range in.LocalStorage_Legacy {
				if v96 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.ReplicateTo == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v98, v99 := range in.ReplicateTo {
				if v98 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "Targets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v100 StorageFreeSpaceInfo
					(v100).UnmarshalEasyJSON(in)
					out.Targets = append(out.Targets, v100)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode64(out *jwriter.Writer, in SpannedStorageExtraInfo) {
	...
	_ = first
	{
		...
		if in.Targets == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v101, v102 := range in.Targets {
				if v101 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "SpanTargets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v103 DestinationLocation
					(v103).UnmarshalEasyJSON(in)
					out.SpanTargets = append(out.SpanTargets, v103)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode65(out *jwriter.Writer, in SpannedDestinationLocation) {
	...
	_ = first
	{
		...
		if in.SpanTargets == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v104, v105 := range in.SpanTargets {
				if v104 > 0 {
					out.RawByte(',')
				}
		...
		case "PreExec":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.PreExec = append(out.PreExec, v106)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ThawExec":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ThawExec = append(out.ThawExec, v107)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "PostExec":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.PostExec = append(out.PostExec, v108)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode68(out *jwriter.Writer, in SourceConfig) {
	...
	}
	{
		...
		if in.PreExec == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v111, v112 := range in.PreExec {
				if v111 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.ThawExec == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v113, v114 := range in.ThawExec {
				if v113 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.PostExec == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v115, v116 := range in.PostExec {
				if v115 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.EngineProps == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v117First := true
			for v117Name, v117Value := range in.EngineProps {
				if v117First {
					v117First = false
				} else {
					out.RawByte(',')
	...
	if len(in.OverrideDestinationRetention) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v118First := true
			for v118Name, v118Value := range in.OverrideDestinationRetention {
				if v118First {
					v118First = false
				} else {
					out.RawByte(',')
		...
		case "OverrideDestinationRetention":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v119 RetentionPolicy
					(v119).UnmarshalEasyJSON(in)
					(out.OverrideDestinationRetention)[key] = v119
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode69(out *jwriter.Writer, in SourceBasicInfo) {
	...
	if len(in.OverrideDestinationRetention) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v120First := true
			for v120Name, v120Value := range in.OverrideDestinationRetention {
				if v120First {
					v120First = false
				} else {
					out.RawByte(',')
		...
		case "updates_info":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.WhatsNew = append(out.WhatsNew, v121)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode70(out *jwriter.Writer, in SoftwareUpdateNewsResponse) {
	...
	}
	{
		...
		if in.WhatsNew == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v122, v123 := range in.WhatsNew {
				if v122 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "ExperimentalOptions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ExperimentalOptions = append(out.ExperimentalOptions, v124)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "SelfBackup":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v126 SelfBackupStatistics
					(v126).UnmarshalEasyJSON(in)
					out.SelfBackup = append(out.SelfBackup, v126)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode76(out *jwriter.Writer, in ServerMetaVersionInfo) {
	...
	if len(in.ExperimentalOptions) != 0 {
		...
		{
			out.RawByte('[')
			for v127, v128 := range in.ExperimentalOptions {
				if v127 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.BoosterLimit == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v129First := true
			for v129Name, v129Value := range in.BoosterLimit {
				if v129First {
					v129First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.SelfBackup == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v130, v131 := range in.SelfBackup {
				if v130 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "ExternalAuthenticationSources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v132 ExternalAuthenticationSourceDisplay
					(v132).UnmarshalEasyJSON(in)
					out.ExternalAuthenticationSources = append(out.ExternalAuthenticationSources, v132)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode77(out *jwriter.Writer, in ServerMetaBrandingProperties) {
	...
	if len(in.ExternalAuthenticationSources) != 0 {
		...
		{
			out.RawByte('[')
			for v133, v134 := range in.ExternalAuthenticationSources {
				if v133 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "AdminUsers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v135 AllowedAdminUser
					(v135).UnmarshalEasyJSON(in)
					out.AdminUsers = append(out.AdminUsers, v135)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "ExperimentalOptions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ExperimentalOptions = append(out.ExperimentalOptions, v136)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ExternalAdminUserSources":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v137 ExternalAuthenticationSource
					(v137).UnmarshalEasyJSON(in)
					(out.ExternalAdminUserSources)[key] = v137
					in.WantComma()
				}
				in.Delim('}')
			}
		...
		case "ListenAddresses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v138 HTTPConnectorOptions
					(v138).UnmarshalEasyJSON(in)
					out.ListenAddresses = append(out.ListenAddresses, v138)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Organizations":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v139 Organization
					(v139).UnmarshalEasyJSON(in)
					(out.Organizations)[key] = v139
					in.WantComma()
				}
				in.Delim('}')
			}
		case "PSAConfigs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.PSAConfigs = append(out.PSAConfigs, v140)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "WebhookOptions":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v141 WebhookOption
					(v141).UnmarshalEasyJSON(in)
					(out.WebhookOptions)[key] = v141
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode80(out *jwriter.Writer, in ServerConfigOptions) {
	...
	_ = first
	{
		...
		if in.AdminUsers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v143, v144 := range in.AdminUsers {
				if v143 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.ExperimentalOptions) != 0 {
		...
		{
			out.RawByte('[')
			for v145, v146 := range in.ExperimentalOptions {
				if v145 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.ExternalAdminUserSources == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v147First := true
			for v147Name, v147Value := range in.ExternalAdminUserSources {
				if v147First {
					v147First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.ListenAddresses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v148, v149 := range in.ListenAddresses {
				if v148 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Organizations == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v150First := true
			for v150Name, v150Value := range in.Organizations {
				if v150First {
					v150First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.PSAConfigs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v151, v152 := range in.PSAConfigs {
				if v151 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.WebhookOptions == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v153First := true
			for v153Name, v153Value := range in.WebhookOptions {
				if v153First {
					v153First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.AuditFileOptions == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v154First := true
			for v154Name, v154Value := range in.AuditFileOptions {
				if v154First {
					v154First = false
				} else {
					out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "Schedule":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v155 ScheduleConfig
					(v155).UnmarshalEasyJSON(in)
					out.Schedule = append(out.Schedule, v155)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode81(out *jwriter.Writer, in SelfBackupTarget) {
	...
	_ = first
	{
		...
		if in.Schedule == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v156, v157 := range in.Schedule {
				if v156 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "Targets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v158 SelfBackupTarget
					(v158).UnmarshalEasyJSON(in)
					out.Targets = append(out.Targets, v158)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode83(out *jwriter.Writer, in SelfBackupOptions) {
	...
	_ = first
	{
		...
		if in.Targets == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v159, v160 := range in.Targets {
				if v159 > 0 {
					out.RawByte(',')
				}
			...
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					if in.IsNull() {
						...
						if v161 == nil {
							if !in.IsDelim(']') {
								v161 = make([]SearchResultFileInfo, 0, 0)
							} else {
								v161 = []SearchResultFileInfo{}
							}
						} else {
							v161 = (v161)[:0]
						}
						for !in.IsDelim(']') {
							var v162 SearchResultFileInfo
							(v162).UnmarshalEasyJSON(in)
							v161 = append(v161, v162)
							in.WantComma()
						}
						in.Delim(']')
					}
					(out.SnapshotFiles)[key] = v161
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode85(out *jwriter.Writer, in SearchSnapshotsResponse) {
	...
	}
	{
		...
		if in.SnapshotFiles == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v163First := true
			for v163Name, v163Value := range in.SnapshotFiles {
				if v163First {
					v163First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v163Value == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
					out.RawString("null")
				} else {
					out.RawByte('[')
					for v164, v165 := range v163Value {
						if v164 > 0 {
							out.RawByte(',')
						}
	...
	for !in.IsDelim('}') {
		...
		case "ClauseChildren":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v166 SearchClause
					(v166).UnmarshalEasyJSON(in)
					out.ClauseChildren = append(out.ClauseChildren, v166)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode87(out *jwriter.Writer, in SearchClause) {
	...
	if len(in.ClauseChildren) != 0 {
		...
		{
			out.RawByte('[')
			for v167, v168 := range in.ClauseChildren {
				if v167 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "Ranges":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v169 RetentionRange
					(v169).UnmarshalEasyJSON(in)
					out.Ranges = append(out.Ranges, v169)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "ExactDestPaths":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ExactDestPaths = append(out.ExactDestPaths, v172)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode96(out *jwriter.Writer, in RestoreJobAdvancedOptions) {
	...
	}
	{
		...
		if in.ExactDestPaths == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v173, v174 := range in.ExactDestPaths {
				if v173 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "Rules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v175 RatelimitRule
					(v175).UnmarshalEasyJSON(in)
					out.Rules = append(out.Rules, v175)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Decode111(in *jlexer.Lexer, out *ProtectedItemWithBackupRulesResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "BackupRules":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v178 BackupRuleConfig
					(v178).UnmarshalEasyJSON(in)
					(out.BackupRules)[key] = v178
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode111(out *jwriter.Writer, in ProtectedItemWithBackupRulesResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if len(in.BackupRules) != 0 {
		const prefix string = ",\"BackupRules\":"
		out.RawString(prefix)
		{
			out.RawByte('{')
			v179First := true
			for v179Name, v179Value := range in.BackupRules {
				if v179First {
					v179First = false
				} else {
					out.RawByte(',')
...
// MarshalJSON supports json.Marshaler interface
func (v ProtectedItemWithBackupRulesResponse) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v ProtectedItemWithBackupRulesResponse) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonB7f3de24Encode111(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *ProtectedItemWithBackupRulesResponse) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ProtectedItemWithBackupRulesResponse) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB7f3de24Decode111(l, v)
}
func easyjsonB7f3de24Decode112(in *jlexer.Lexer, out *ProtectedItemEngineTypePolicy) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "AllowedEngineTypeWhenRestricted":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AllowedEngineTypeWhenRestricted = append(out.AllowedEngineTypeWhenRestricted, v180)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode112(out *jwriter.Writer, in ProtectedItemEngineTypePolicy) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.AllowedEngineTypeWhenRestricted == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v181, v182 := range in.AllowedEngineTypeWhenRestricted {
				if v181 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode113(in *jlexer.Lexer, out *PrivateBrandingProperties) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode113(out *jwriter.Writer, in PrivateBrandingProperties) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode114(in *jlexer.Lexer, out *PolicyOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "DeleteSources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.DeleteSources = append(out.DeleteSources, v183)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode114(out *jwriter.Writer, in PolicyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.DeleteSources == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v184, v185 := range in.DeleteSources {
				if v184 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode115(in *jlexer.Lexer, out *PartitionConflict) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode115(out *jwriter.Writer, in PartitionConflict) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode116(in *jlexer.Lexer, out *Partition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "MountPoints":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MountPoints = append(out.MountPoints, v186)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode116(out *jwriter.Writer, in Partition) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.MountPoints == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v187, v188 := range in.MountPoints {
				if v187 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode117(in *jlexer.Lexer, out *PVEVM) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "Disks":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Disks = append(out.Disks, v189)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode117(out *jwriter.Writer, in PVEVM) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode118(in *jlexer.Lexer, out *PVEStorageName) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode118(out *jwriter.Writer, in PVEStorageName) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "Exclusions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v192 PVEBackupNode
					(v192).UnmarshalEasyJSON(in)
					out.Exclusions = append(out.Exclusions, v192)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "Selections":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v193 PVEBackupNode
					(v193).UnmarshalEasyJSON(in)
					out.Selections = append(out.Selections, v193)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "UseCBT":
			out.UseCBT = bool(in.Bool())
		default:
			out.UnmarshalUnknown(in, key)
		}
		in.WantComma()
...
func easyjsonB7f3de24Encode119(out *jwriter.Writer, in PVEParams) {
	...
	if len(in.Exclusions) != 0 {
		...
		{
			out.RawByte('[')
			for v194, v195 := range in.Exclusions {
				if v194 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Selections) != 0 {
		...
		{
			out.RawByte('[')
			for v196, v197 := range in.Selections {
				if v196 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "IncludedDisks":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v198 PVEBackupDisk
					(v198).UnmarshalEasyJSON(in)
					out.IncludedDisks = append(out.IncludedDisks, v198)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode121(out *jwriter.Writer, in PVEBackupVM) {
	...
	if len(in.IncludedDisks) != 0 {
		...
		{
			out.RawByte('[')
			for v199, v200 := range in.IncludedDisks {
				if v199 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "IncludedVMs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v201 PVEBackupVM
					(v201).UnmarshalEasyJSON(in)
					out.IncludedVMs = append(out.IncludedVMs, v201)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode122(out *jwriter.Writer, in PVEBackupNode) {
	...
	if len(in.IncludedVMs) != 0 {
		...
		{
			out.RawByte('[')
			for v202, v203 := range in.IncludedVMs {
				if v202 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Encode125(out *jwriter.Writer, in PSAConfig) {
	...
	if len(in.CustomHeaders) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v205First := true
			for v205Name, v205Value := range in.CustomHeaders {
				if v205First {
					v205First = false
				} else {
					out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "ExperimentalOptions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v207 string
					v207 = string(in.String())
					out.ExperimentalOptions = append(out.ExperimentalOptions, v207)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Hosts":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Hosts = append(out.Hosts, v208)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "PSAConfigs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.PSAConfigs = append(out.PSAConfigs, v209)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "RemoteStorage":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v210 RemoteStorageOption
					(v210).UnmarshalEasyJSON(in)
					out.RemoteStorage = append(out.RemoteStorage, v210)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "WebhookOptions":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v211 WebhookOption
					(v211).UnmarshalEasyJSON(in)
					(out.WebhookOptions)[key] = v211
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode128(out *jwriter.Writer, in Organization) {
	...
	_ = first
	{
		...
		if in.AuditFileOptions == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v212First := true
			for v212Name, v212Value := range in.AuditFileOptions {
				if v212First {
					v212First = false
				} else {
					out.RawByte(',')
	...
	if len(in.ExperimentalOptions) != 0 {
		...
		{
			out.RawByte('[')
			for v213, v214 := range in.ExperimentalOptions {
				if v213 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.PSAConfigs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v217, v218 := range in.PSAConfigs {
				if v217 > 0 {
					out.RawByte(',')
				}
				(v218).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.RemoteStorage == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v219, v220 := range in.RemoteStorage {
				if v219 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.WebhookOptions == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v221First := true
			for v221Name, v221Value := range in.WebhookOptions {
				if v221First {
					v221First = false
				} else {
					out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "Hosts":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Hosts = append(out.Hosts, v222)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "Scopes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v223 string
					v223 = string(in.String())
					out.Scopes = append(out.Scopes, v223)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "RequiredClaims":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RequiredClaims = append(out.RequiredClaims, v224)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode129(out *jwriter.Writer, in OidcConfig) {
	...
	if len(in.RequiredClaims) != 0 {
		...
		{
			out.RawByte('[')
			for v229, v230 := range in.RequiredClaims {
				if v229 > 0 {
					out.RawByte(',')
				}
				(v230).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
		...
		case "Members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Members = append(out.Members, v231)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode131(out *jwriter.Writer, in Office365ObjectInfo) {
	...
	}
	{
		...
		if in.Members == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v232, v233 := range in.Members {
				if v232 > 0 {
					out.RawByte(',')
				}
		...
		case "Members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Members = append(out.Members, v234)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode132(out *jwriter.Writer, in Office365MixedVirtualAccount) {
	...
	if len(in.Members) != 0 {
		...
		{
			out.RawByte('[')
			for v235, v236 := range in.Members {
				if v235 > 0 {
					out.RawByte(',')
				}
		...
		case "MemberBackupOptions":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					var v238 uint
					v238 = uint(in.Uint())
					(out.MemberBackupOptions)[key] = v238
					in.WantComma()
				}
				in.Delim('}')
			}
		...
		case "FilterMemberOptions":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					var v240 uint
					v240 = uint(in.Uint())
					(out.FilterMemberOptions)[key] = v240
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode133(out *jwriter.Writer, in Office365CustomSettingV2) {
	...
	if len(in.BackupOptions) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v241First := true
			for v241Name, v241Value := range in.BackupOptions {
				if v241First {
					v241First = false
				} else {
					out.RawByte(',')
	...
	if len(in.MemberBackupOptions) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v242First := true
			for v242Name, v242Value := range in.MemberBackupOptions {
				if v242First {
					v242First = false
				} else {
					out.RawByte(',')
	...
	if len(in.FilterOptions) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v243First := true
			for v243Name, v243Value := range in.FilterOptions {
				if v243First {
					v243First = false
				} else {
					out.RawByte(',')
				}
				out.String(string(v243Name))
				out.RawByte(':')
				out.Uint(uint(v243Value))
			}
			out.RawByte('}')
		}
	}
	if len(in.FilterMemberOptions) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v244First := true
			for v244Name, v244Value := range in.FilterMemberOptions {
				if v244First {
					v244First = false
				} else {
					out.RawByte(',')
		...
		case "MailboxUserIDs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MailboxUserIDs = append(out.MailboxUserIDs, v245)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "MailboxGroupIDs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MailboxGroupIDs = append(out.MailboxGroupIDs, v246)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "SiteIDs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SiteIDs = append(out.SiteIDs, v247)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode134(out *jwriter.Writer, in Office365CustomSetting) {
	...
	}
	{
		...
		if in.MailboxUserIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v248, v249 := range in.MailboxUserIDs {
				if v248 > 0 {
					out.RawByte(',')
				}
				out.String(string(v249))
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.MailboxGroupIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v250, v251 := range in.MailboxGroupIDs {
				if v250 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.SiteIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v252, v253 := range in.SiteIDs {
				if v252 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "MailboxUniqueMembers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v254 string
					v254 = string(in.String())
					out.MailboxUniqueMembers = append(out.MailboxUniqueMembers, v254)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "SiteUniqueMembers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SiteUniqueMembers = append(out.SiteUniqueMembers, v255)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode136(out *jwriter.Writer, in Office365Connection) {
	...
	}
	{
		...
		if in.MailboxUniqueMembers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v256, v257 := range in.MailboxUniqueMembers {
				if v256 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.SiteUniqueMembers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v258, v259 := range in.SiteUniqueMembers {
				if v258 > 0 {
					out.RawByte(',')
				}
		...
		case "ReplicaMembers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ReplicaMembers = append(out.ReplicaMembers, v260)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode142(out *jwriter.Writer, in MongoDBConnection) {
	...
	}
	{
		...
		if in.ReplicaMembers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v261, v262 := range in.ReplicaMembers {
				if v261 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Encode151(out *jwriter.Writer, in LicenseLimits) {
	...
	if len(in.BoosterCount) != 0 {
		...
		}
		{
			out.RawByte('{')
			v264First := true
			for v264Name, v264Value := range in.BoosterCount {
				if v264First {
					v264First = false
				} else {
					out.RawByte(',')
		...
		case "HardDrives":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.HardDrives = append(out.HardDrives, v265)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode159(out *jwriter.Writer, in HyperVMachineInfo) {
	...
	}
	{
		...
		if in.HardDrives == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v266, v267 := range in.HardDrives {
				if v266 > 0 {
					out.RawByte(',')
				}
				out.String(string(v267))
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Encode164(out *jwriter.Writer, in GetUserGroupWithUsersResponse) {
	...
	}
	{
		...
		if in.Users == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v269First := true
			for v269Name, v269Value := range in.Users {
				if v269First {
					v269First = false
				} else {
					out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "AllowEventTypes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v270 StreamableEventType
					v270 = StreamableEventType(in.Int())
					out.AllowEventTypes = append(out.AllowEventTypes, v270)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode169(out *jwriter.Writer, in FileOption) {
	...
	if len(in.AllowEventTypes) != 0 {
		...
		{
			out.RawByte('[')
			for v271, v272 := range in.AllowEventTypes {
				if v271 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v272))
	...
	for !in.IsDelim('}') {
		...
		case "FallbackServers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v273 ExternalLDAPAuthenticationSourceServer
					(v273).UnmarshalEasyJSON(in)
					out.FallbackServers = append(out.FallbackServers, v273)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode172(out *jwriter.Writer, in ExternalLDAPAuthenticationSourceSettings) {
	...
	}
	{
		...
		if in.FallbackServers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v274, v275 := range in.FallbackServers {
				if v274 > 0 {
					out.RawByte(',')
				}
				(v275).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
		...
		case "Recipients":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Recipients = append(out.Recipients, v276)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode177(out *jwriter.Writer, in EmailReportingOption) {
	...
	}
	{
		...
		if in.Recipients == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v277, v278 := range in.Recipients {
				if v277 > 0 {
					out.RawByte(',')
				}
				out.String(string(v278))
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "SummaryFrequency":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v282 ScheduleConfig
					(v282).UnmarshalEasyJSON(in)
					out.SummaryFrequency = append(out.SummaryFrequency, v282)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode179(out *jwriter.Writer, in EmailReportConfig) {
	...
	}
	{
		...
		if in.SummaryFrequency == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v283, v284 := range in.SummaryFrequency {
				if v283 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "EmailReportingOptions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v285 EmailReportingOption
					(v285).UnmarshalEasyJSON(in)
					out.EmailReportingOptions = append(out.EmailReportingOptions, v285)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode180(out *jwriter.Writer, in EmailOptions) {
	...
	if len(in.EmailReportingOptions) != 0 {
		...
		{
			out.RawByte('[')
			for v286, v287 := range in.EmailReportingOptions {
				if v286 > 0 {
					out.RawByte(',')
				}
				(v287).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
		...
		case "WindiskSnapshot":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.WindiskSnapshot = append(out.WindiskSnapshot, v288)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode182(out *jwriter.Writer, in DispatcherWindiskSnapshotResponse) {
	...
	}
	{
		...
		if in.WindiskSnapshot == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v289, v290 := range in.WindiskSnapshot {
				if v289 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "Snapshots":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v291 VaultSnapshot
					(v291).UnmarshalEasyJSON(in)
					out.Snapshots = append(out.Snapshots, v291)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode183(out *jwriter.Writer, in DispatcherVaultSnapshotsResponse) {
	...
	}
	{
		...
		if in.Snapshots == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v292, v293 := range in.Snapshots {
				if v292 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "StoredObjects":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v294 StoredObject
					(v294).UnmarshalEasyJSON(in)
					out.StoredObjects = append(out.StoredObjects, v294)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode184(out *jwriter.Writer, in DispatcherStoredObjectsResponse) {
	...
	}
	{
		...
		if in.StoredObjects == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v295, v296 := range in.StoredObjects {
				if v295 > 0 {
					out.RawByte(',')
				}
				(v296).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Encode186(out *jwriter.Writer, in DispatcherAdminSourcesResponse) {
	...
	}
	{
		...
		if in.ImportSources == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v301First := true
			for v301Name, v301Value := range in.ImportSources {
				if v301First {
					v301First = false
				} else {
					out.RawByte(',')
...
func easyjsonB7f3de24Decode187(in *jlexer.Lexer, out *DispatchWithJobIDResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode187(out *jwriter.Writer, in DispatchWithJobIDResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
// MarshalJSON supports json.Marshaler interface
func (v DispatchWithJobIDResponse) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v DispatchWithJobIDResponse) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonB7f3de24Encode187(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *DispatchWithJobIDResponse) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *DispatchWithJobIDResponse) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB7f3de24Decode187(l, v)
}
func easyjsonB7f3de24Decode188(in *jlexer.Lexer, out *DiskDrive) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Partitions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v302 Partition
					(v302).UnmarshalEasyJSON(in)
					out.Partitions = append(out.Partitions, v302)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "DeviceParents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v303 string
					v303 = string(in.String())
					out.DeviceParents = append(out.DeviceParents, v303)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "PartitionConflicts":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v304 PartitionConflict
					(v304).UnmarshalEasyJSON(in)
					out.PartitionConflicts = append(out.PartitionConflicts, v304)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode188(out *jwriter.Writer, in DiskDrive) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Partitions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v305, v306 := range in.Partitions {
				if v305 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.DeviceParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v307, v308 := range in.DeviceParents {
				if v307 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.PartitionConflicts == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v309, v310 := range in.PartitionConflicts {
				if v309 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode189(in *jlexer.Lexer, out *DeviceConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "Sources":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v311 SourceBasicInfo
					(v311).UnmarshalEasyJSON(in)
					(out.Sources)[key] = v311
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode189(out *jwriter.Writer, in DeviceConfig) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if len(in.Sources) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v312First := true
			for v312Name, v312Value := range in.Sources {
				if v312First {
					v312First = false
				} else {
					out.RawByte(',')
...
func easyjsonB7f3de24Decode190(in *jlexer.Lexer, out *DestinationStatistics) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode190(out *jwriter.Writer, in DestinationStatistics) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode191(in *jlexer.Lexer, out *DestinationLocation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "SpanTargets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v313 DestinationLocation
					(v313).UnmarshalEasyJSON(in)
					out.SpanTargets = append(out.SpanTargets, v313)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode191(out *jwriter.Writer, in DestinationLocation) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.SpanTargets == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v314, v315 := range in.SpanTargets {
				if v314 > 0 {
					out.RawByte(',')
				}
				(v315).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Decode192(in *jlexer.Lexer, out *DestinationConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "PreExec":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.PreExec = append(out.PreExec, v316)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ThawExec":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ThawExec = append(out.ThawExec, v317)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "PostExec":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.PostExec = append(out.PostExec, v318)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "SpanTargets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v319 DestinationLocation
					(v319).UnmarshalEasyJSON(in)
					out.SpanTargets = append(out.SpanTargets, v319)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "AssociatedDevices":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AssociatedDevices = append(out.AssociatedDevices, v320)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode192(out *jwriter.Writer, in DestinationConfig) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.PreExec == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v321, v322 := range in.PreExec {
				if v321 > 0 {
					out.RawByte(',')
				}
				out.String(string(v322))
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.ThawExec == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v323, v324 := range in.ThawExec {
				if v323 > 0 {
					out.RawByte(',')
				}
				out.String(string(v324))
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.PostExec == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v325, v326 := range in.PostExec {
				if v325 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.SpanTargets == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v327, v328 := range in.SpanTargets {
				if v327 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.AssociatedDevices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v329, v330 := range in.AssociatedDevices {
				if v329 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode193(in *jlexer.Lexer, out *DefaultSourceWithOSRestriction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode193(out *jwriter.Writer, in DefaultSourceWithOSRestriction) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode194(in *jlexer.Lexer, out *DefaultEmailReportPolicy) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Reports":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v331 EmailReportConfig
					(v331).UnmarshalEasyJSON(in)
					out.Reports = append(out.Reports, v331)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode194(out *jwriter.Writer, in DefaultEmailReportPolicy) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Reports == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v332, v333 := range in.Reports {
				if v332 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode195(in *jlexer.Lexer, out *DaysOfWeekConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode195(out *jwriter.Writer, in DaysOfWeekConfig) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode196(in *jlexer.Lexer, out *CustomRemoteBucketSettings) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode196(out *jwriter.Writer, in CustomRemoteBucketSettings) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.CustomHeaders == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v335First := true
			for v335Name, v335Value := range in.CustomHeaders {
				if v335First {
					v335First = false
				} else {
					out.RawByte(',')
				}
				out.String(string(v335Name))
				out.RawByte(':')
				out.String(string(v335Value))
			}
			out.RawByte('}')
		}
	}
...
func easyjsonB7f3de24Decode197(in *jlexer.Lexer, out *CreateUserGroupResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode197(out *jwriter.Writer, in CreateUserGroupResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode198(in *jlexer.Lexer, out *CreateGroupPolicyResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode198(out *jwriter.Writer, in CreateGroupPolicyResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode199(in *jlexer.Lexer, out *CountJobsResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode199(out *jwriter.Writer, in CountJobsResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode200(in *jlexer.Lexer, out *ContentMeasurementComponent) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "UsedBy":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v336 string
					v336 = string(in.String())
					out.UsedBy = append(out.UsedBy, v336)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode200(out *jwriter.Writer, in ContentMeasurementComponent) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.UsedBy == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v337, v338 := range in.UsedBy {
				if v337 > 0 {
					out.RawByte(',')
				}
				out.String(string(v338))
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Decode201(in *jlexer.Lexer, out *ContentMeasurement) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Components":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v339 ContentMeasurementComponent
					(v339).UnmarshalEasyJSON(in)
					out.Components = append(out.Components, v339)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode201(out *jwriter.Writer, in ContentMeasurement) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Components == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v340, v341 := range in.Components {
				if v340 > 0 {
					out.RawByte(',')
				}
				(v341).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Decode202(in *jlexer.Lexer, out *ConstellationStatusAPIResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Targets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v342 string
					v342 = string(in.String())
					out.Targets = append(out.Targets, v342)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "TargetNames":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v343 string
					v343 = string(in.String())
					out.TargetNames = append(out.TargetNames, v343)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode202(out *jwriter.Writer, in ConstellationStatusAPIResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Targets == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v344, v345 := range in.Targets {
				if v344 > 0 {
					out.RawByte(',')
				}
				out.String(string(v345))
			}
			out.RawByte(']')
		}
	}
	if len(in.TargetNames) != 0 {
		...
		{
			out.RawByte('[')
			for v346, v347 := range in.TargetNames {
				if v346 > 0 {
					out.RawByte(',')
				}
				out.String(string(v347))
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Decode203(in *jlexer.Lexer, out *ConstellationStats) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode203(out *jwriter.Writer, in ConstellationStats) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode204(in *jlexer.Lexer, out *ConstellationRoleOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Servers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v348 RemoteServerAddress
					(v348).UnmarshalEasyJSON(in)
					out.Servers = append(out.Servers, v348)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode204(out *jwriter.Writer, in ConstellationRoleOptions) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Servers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v349, v350 := range in.Servers {
				if v349 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode205(in *jlexer.Lexer, out *ConstellationCheckReport) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode205(out *jwriter.Writer, in ConstellationCheckReport) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Usage == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v352First := true
			for v352Name, v352Value := range in.Usage {
				if v352First {
					v352First = false
				} else {
					out.RawByte(',')
				}
				out.String(string(v352Name))
				out.RawByte(':')
...
func easyjsonB7f3de24Decode206(in *jlexer.Lexer, out *CometDestinationLocation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode206(out *jwriter.Writer, in CometDestinationLocation) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode207(in *jlexer.Lexer, out *CometAPIResponseMessage) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode207(out *jwriter.Writer, in CometAPIResponseMessage) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode208(in *jlexer.Lexer, out *BucketUsageInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "ExistsOnServers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v353 int
					v353 = int(in.Int())
					out.ExistsOnServers = append(out.ExistsOnServers, v353)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "InUseBy":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v354 UserOnServer
					(v354).UnmarshalEasyJSON(in)
					out.InUseBy = append(out.InUseBy, v354)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode208(out *jwriter.Writer, in BucketUsageInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.ExistsOnServers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v355, v356 := range in.ExistsOnServers {
				if v355 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v356))
	...
	}
	{
		...
		if in.InUseBy == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v357, v358 := range in.InUseBy {
				if v357 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode209(in *jlexer.Lexer, out *BucketProperties) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode209(out *jwriter.Writer, in BucketProperties) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode210(in *jlexer.Lexer, out *BrowseVSSResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "VSSWriters":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v359 VSSWriterInfo
					(v359).UnmarshalEasyJSON(in)
					(out.VSSWriters)[key] = v359
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode210(out *jwriter.Writer, in BrowseVSSResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.VSSWriters == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v360First := true
			for v360Name, v360Value := range in.VSSWriters {
				if v360First {
					v360First = false
				} else {
					out.RawByte(',')
				}
				out.String(string(v360Name))
				out.RawByte(':')
				(v360Value).MarshalEasyJSON(out)
			}
			out.RawByte('}')
		}
	}
...
func easyjsonB7f3de24Decode211(in *jlexer.Lexer, out *BrowseVMwareResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "VirtualMachines":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v361 VMwareMachineInfo
					(v361).UnmarshalEasyJSON(in)
					out.VirtualMachines = append(out.VirtualMachines, v361)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode211(out *jwriter.Writer, in BrowseVMwareResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.VirtualMachines == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v362, v363 := range in.VirtualMachines {
				if v362 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode212(in *jlexer.Lexer, out *BrowseVMwareNetworksResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Networks":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v364 VMwareNetworkInfo
					(v364).UnmarshalEasyJSON(in)
					out.Networks = append(out.Networks, v364)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode212(out *jwriter.Writer, in BrowseVMwareNetworksResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Networks == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v365, v366 := range in.Networks {
				if v365 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode213(in *jlexer.Lexer, out *BrowseVMwareHostsResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Hosts":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v367 VMwareHostInfo
					(v367).UnmarshalEasyJSON(in)
					out.Hosts = append(out.Hosts, v367)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode213(out *jwriter.Writer, in BrowseVMwareHostsResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode214(in *jlexer.Lexer, out *BrowseVMwareDatastoresResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Datastores":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v370 VMwareDatastoreInfo
					(v370).UnmarshalEasyJSON(in)
					out.Datastores = append(out.Datastores, v370)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode214(out *jwriter.Writer, in BrowseVMwareDatastoresResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Datastores == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v371, v372 := range in.Datastores {
				if v371 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode215(in *jlexer.Lexer, out *BrowseVMwareDatacentersResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Datacenters":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v373 VMwareDatacenterInfo
					(v373).UnmarshalEasyJSON(in)
					out.Datacenters = append(out.Datacenters, v373)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode215(out *jwriter.Writer, in BrowseVMwareDatacentersResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Datacenters == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v374, v375 := range in.Datacenters {
				if v374 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode216(in *jlexer.Lexer, out *BrowseSQLServerResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "Objects":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v376 string
					v376 = string(in.String())
					(out.Objects)[key] = v376
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode216(out *jwriter.Writer, in BrowseSQLServerResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Objects == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v377First := true
			for v377Name, v377Value := range in.Objects {
				if v377First {
					v377First = false
				} else {
					out.RawByte(',')
				}
				out.String(string(v377Name))
				out.RawByte(':')
				out.String(string(v377Value))
			}
			out.RawByte('}')
		}
	}
...
func easyjsonB7f3de24Decode217(in *jlexer.Lexer, out *BrowseProxmoxStorageResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Storage":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v378 PVEStorageName
					(v378).UnmarshalEasyJSON(in)
					out.Storage = append(out.Storage, v378)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode217(out *jwriter.Writer, in BrowseProxmoxStorageResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Storage == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v379, v380 := range in.Storage {
				if v379 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode218(in *jlexer.Lexer, out *BrowseProxmoxResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "VMs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v381 PVEVM
					(v381).UnmarshalEasyJSON(in)
					out.VMs = append(out.VMs, v381)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode218(out *jwriter.Writer, in BrowseProxmoxResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.VMs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v382, v383 := range in.VMs {
				if v382 > 0 {
					out.RawByte(',')
				}
				(v383).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Decode219(in *jlexer.Lexer, out *BrowseProxmoxNodesResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Nodes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v384 string
					v384 = string(in.String())
					out.Nodes = append(out.Nodes, v384)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode219(out *jwriter.Writer, in BrowseProxmoxNodesResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Nodes == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v385, v386 := range in.Nodes {
				if v385 > 0 {
					out.RawByte(',')
				}
				out.String(string(v386))
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Decode220(in *jlexer.Lexer, out *BrowseOffice365ObjectsResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Objects":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v387 Office365ObjectInfo
					(v387).UnmarshalEasyJSON(in)
					out.Objects = append(out.Objects, v387)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode220(out *jwriter.Writer, in BrowseOffice365ObjectsResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Objects == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v388, v389 := range in.Objects {
				if v388 > 0 {
					out.RawByte(',')
				}
				(v389).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Decode221(in *jlexer.Lexer, out *BrowseOffice365ListVirtualAccountsResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Objects":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v390 Office365MixedVirtualAccount
					(v390).UnmarshalEasyJSON(in)
					out.Objects = append(out.Objects, v390)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode221(out *jwriter.Writer, in BrowseOffice365ListVirtualAccountsResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Objects == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v391, v392 := range in.Objects {
				if v391 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode222(in *jlexer.Lexer, out *BrowseHVResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "VirtualMachines":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v393 HyperVMachineInfo
					(v393).UnmarshalEasyJSON(in)
					out.VirtualMachines = append(out.VirtualMachines, v393)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode222(out *jwriter.Writer, in BrowseHVResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.VirtualMachines == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v394, v395 := range in.VirtualMachines {
				if v394 > 0 {
					out.RawByte(',')
				}
				(v395).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Decode223(in *jlexer.Lexer, out *BrowseEDBResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Databases":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v396 EDBFileInfo
					(v396).UnmarshalEasyJSON(in)
					out.Databases = append(out.Databases, v396)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode223(out *jwriter.Writer, in BrowseEDBResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Databases == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v397, v398 := range in.Databases {
				if v397 > 0 {
					out.RawByte(',')
				}
...
func easyjsonB7f3de24Decode224(in *jlexer.Lexer, out *BrowseDiskDrivesResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Disks":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v399 DiskDrive
					(v399).UnmarshalEasyJSON(in)
					out.Disks = append(out.Disks, v399)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode224(out *jwriter.Writer, in BrowseDiskDrivesResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Disks == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v400, v401 := range in.Disks {
				if v400 > 0 {
					out.RawByte(',')
				}
				(v401).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB7f3de24Decode225(in *jlexer.Lexer, out *BrandingProperties) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode225(out *jwriter.Writer, in BrandingProperties) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonB7f3de24Decode226(in *jlexer.Lexer, out *BrandingOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB7f3de24Encode226(out *jwriter.Writer, in BrandingOptions) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "PreExec":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v402 string
					v402 = string(in.String())
					out.PreExec = append(out.PreExec, v402)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ThawExec":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ThawExec = append(out.ThawExec, v403)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "PostExec":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v404 string
					v404 = string(in.String())
					out.PostExec = append(out.PostExec, v404)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "Schedules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v405 ScheduleConfig
					(v405).UnmarshalEasyJSON(in)
					out.Schedules = append(out.Schedules, v405)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode228(out *jwriter.Writer, in BackupRuleConfig) {
	...
	}
	{
		...
		if in.PreExec == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v406, v407 := range in.PreExec {
				if v406 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.ThawExec == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v408, v409 := range in.ThawExec {
				if v408 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.PostExec == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v410, v411 := range in.PostExec {
				if v410 > 0 {
					out.RawByte(',')
				}
				out.String(string(v411))
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Schedules == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v412, v413 := range in.Schedules {
				if v412 > 0 {
					out.RawByte(',')
				}
		...
		case "TotalTransactionsInTimeInterval":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v414 B2TransactionTotals
					(v414).UnmarshalEasyJSON(in)
					(out.TotalTransactionsInTimeInterval)[key] = v414
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB7f3de24Encode234(out *jwriter.Writer, in B2StorageExtraInfo) {
	...
	_ = first
	{
		...
		if in.TotalTransactionsInTimeInterval == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v415First := true
			for v415Name, v415Value := range in.TotalTransactionsInTimeInterval {
				if v415First {
					v415First = false
				} else {
					out.RawByte(',')
				}
				out.Int64Str(int64(v415Name))
				out.RawByte(':')
				(v415Value).MarshalEasyJSON(out)
			}
			out.RawByte('}')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "RemoteStorage":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v416 RemoteStorageOption
					(v416).UnmarshalEasyJSON(in)
					out.RemoteStorage = append(out.RemoteStorage, v416)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ReplicateTo":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v417 ReplicaServer
					(v417).UnmarshalEasyJSON(in)
					out.ReplicateTo = append(out.ReplicateTo, v417)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode238(out *jwriter.Writer, in AuthenticationRoleOptions) {
	...
	}
	{
		...
		if in.RemoteStorage == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v418, v419 := range in.RemoteStorage {
				if v418 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.ReplicateTo == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v420, v421 := range in.ReplicateTo {
				if v420 > 0 {
					out.RawByte(',')
				}
				(v421).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "U2FRegistrations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v422 AdminU2FRegistration
					(v422).UnmarshalEasyJSON(in)
					out.U2FRegistrations = append(out.U2FRegistrations, v422)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "WebAuthnRegistrations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v423 AdminWebAuthnRegistration
					(v423).UnmarshalEasyJSON(in)
					out.WebAuthnRegistrations = append(out.WebAuthnRegistrations, v423)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode240(out *jwriter.Writer, in AllowedAdminUser) {
	...
	if len(in.U2FRegistrations) != 0 {
		...
		{
			out.RawByte('[')
			for v424, v425 := range in.U2FRegistrations {
				if v424 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.WebAuthnRegistrations) != 0 {
		...
		{
			out.RawByte('[')
			for v426, v427 := range in.WebAuthnRegistrations {
				if v426 > 0 {
					out.RawByte(',')
				}
				(v427).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "AllowedProvidersWhenRestricted":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v431 uint64
					v431 = uint64(in.Uint64())
					out.AllowedProvidersWhenRestricted = append(out.AllowedProvidersWhenRestricted, v431)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "AllowedUserPolicies":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v432 string
					v432 = string(in.String())
					out.AllowedUserPolicies = append(out.AllowedUserPolicies, v432)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode242(out *jwriter.Writer, in AdminUserPermissions) {
	...
	if len(in.AllowedProvidersWhenRestricted) != 0 {
		...
		{
			out.RawByte('[')
			for v433, v434 := range in.AllowedProvidersWhenRestricted {
				if v433 > 0 {
					out.RawByte(',')
				}
				out.Uint64(uint64(v434))
			}
			out.RawByte(']')
		}
	}
	if len(in.AllowedUserPolicies) != 0 {
		...
		{
			out.RawByte('[')
			for v435, v436 := range in.AllowedUserPolicies {
				if v435 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "U2FRegistrations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v440 AdminU2FRegistration
					(v440).UnmarshalEasyJSON(in)
					out.U2FRegistrations = append(out.U2FRegistrations, v440)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "WebAuthnRegistrations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v441 AdminWebAuthnRegistration
					(v441).UnmarshalEasyJSON(in)
					out.WebAuthnRegistrations = append(out.WebAuthnRegistrations, v441)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB7f3de24Encode244(out *jwriter.Writer, in AdminSecurityOptions) {
	...
	if len(in.U2FRegistrations) != 0 {
		...
		{
			out.RawByte('[')
			for v442, v443 := range in.U2FRegistrations {
				if v442 > 0 {
					out.RawByte(',')
				}
				(v443).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
	if len(in.WebAuthnRegistrations) != 0 {
		...
		{
			out.RawByte('[')
			for v444, v445 := range in.WebAuthnRegistrations {
				if v444 > 0 {
					out.RawByte(',')
				}
				(v445).MarshalEasyJSON(out)
			}
			out.RawByte(']')
		}
	}
